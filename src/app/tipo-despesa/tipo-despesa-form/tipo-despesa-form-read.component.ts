...
@Component({
  selector: 'app-tipo-despesa-form-read',
  templateUrl: './tipo-despesa-form-read.component.html',
  styleUrls: ['./tipo-despesa-form-read.component.css']
})
export class TipoDespesaFormReadComponent implements OnInit {
