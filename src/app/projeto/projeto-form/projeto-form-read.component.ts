...
@Component({
  selector: 'app-projeto-form-read',
  templateUrl: './projeto-form-read.component.html',
  styleUrls: ['./projeto-form-read.component.css']
})
export class ProjetoFormReadComponent implements OnInit {
